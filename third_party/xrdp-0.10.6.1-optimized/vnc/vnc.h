...
enum vnc_framebuffer_parse_state
{
    VNC_FB_WAIT_MESSAGE_TYPE,
    VNC_FB_WAIT_UPDATE_HEADER,
    VNC_FB_WAIT_RECT_HEADER,
    VNC_FB_WAIT_RAW_DATA
};
...
struct vnc
{
    ...
    int progressive_flush_enabled;
    int progressive_flush_bytes;
    int direct_bitmap_output;
    int gfx_active;
    int progressive_flushes;
    int progressive_bytes_since_flush;
    long long progressive_update_raw_bytes;
    long long progressive_bytes_before_first_flush;
    int profile_enabled;
