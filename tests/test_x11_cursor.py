#!/usr/bin/env python3
"""Run the direct XFixes cursor integration test against authenticated Xvfb."""
...
def main() -> int:
    ...
    auth_directory = tempfile.TemporaryDirectory(
        prefix="xrdp-console-xauthority-cursor-"
    )
    ...
    try:
        ...
        if result.returncode != 0:
            raise AssertionError(
                f"XFixes cursor integration failed with {result.returncode}:\n"
