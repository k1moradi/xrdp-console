#!/usr/bin/env python3
"""Run the direct XCB Damage integration test against authenticated Xvfb."""
...
def main() -> int:
    ...
    auth_directory = tempfile.TemporaryDirectory(
        prefix="xrdp-console-xauthority-damage-"
    )
    ...
    try:
        ...
        if result.returncode != 0:
            raise AssertionError(
                f"XCB Damage integration failed with {result.returncode}:\n"
