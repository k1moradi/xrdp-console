...
The runtime benchmark uses xrdp, x11vnc, FreeRDP, Xvfb, Mesa, and Vulkan from
...
installed by the CMake benchmark package automatically. Its upstream license
and notices remain in that source tree.
...
The optimized xrdp build uses the small x86_64 `libxkbfile` development
...
not a replacement for the host's X11 runtime libraries.
